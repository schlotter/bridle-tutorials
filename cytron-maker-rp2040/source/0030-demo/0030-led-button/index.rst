...
.. topic:: Übersicht
   ...
   werden kann. Du hattest auch gelernt, dass dies nur mit der Einführung der
   zusätzlichen Abstraktion von :ref:`Shields <zephyr:shields>` sinnvoll
   ist – das ist auch weiterhin so. Mit einer solchen Abstraktion würden aber
   auch :ref:`Devicetree Overlays <zephyr:use-dt-overlays>` entstehen und
   genau dieses Konzept hast du nun schon mehrmals angewandt.

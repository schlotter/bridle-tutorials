...
.. topic:: Übersicht
   ...
   Nun werden wir ein Zephyr Standard Beispiel für ADC Treiber dazu benutzen.
   Dieses liest permanent die aktuellen numerischen Werte aus *"deklarierten"*
   ADC Kanälen und gibt sie zusammen mit der errechneten Spannung an der Zephyr
   Console aus. Du wirst nun auch hier einen (weiteren, neuen) **speziellen
   Devicetree Overlay** mit den notwendigen HW-Deklarationen schreiben.
